...
\begin{document}
	...
	\title{Predicting Changes in the Desired Gait Speed of Lower-limb Exoskeleton Users Via Intuitive Physical Human-Robot Interaction}  % Title
	...
	\copyrightlicense{Creative Commons BY 4.0}
	...
	%                       % Either place the text between begin/end, or
	 \include{./Chapters/abstract}    % put it in a file to be included
	...
	\include{./Chapters/background_info}
	%
	% IMM
	\include{./Chapters/IMM}
	%
	% BKF
	\include{./Chapters/BKF}
	%
	% Model Personalization
 	\include{./Chapters/model_personalization}
%    \chapter{Personalization of Gait Speed Estimation in the Presence of Data Scarcity}\label{chapter:MP}
	...
	\bibliographystyle{nddiss2enosort}
