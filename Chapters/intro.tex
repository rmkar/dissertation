...
%\begin{figure}
%	\centering
%	\subcaptionbox{Conventional gait rehabilitation. \cite{gaitrehabgantry}}{\includegraphics[height=3in]{gait_training.jpg}}\label{fig:gantry}%
%	\hfill
%	\subcaptionbox{EksoGT - powered exoskeleton}{\includegraphics[height=3in]{subject.png}}\label{fig:subject}%
%	\caption{Methods of gait rehabilitation}
%\end{figure}
...
\begin{figure}
	...
	\begin{overpic}[width=0.7\linewidth,percent]{intent_flow_chart.pdf}
		\put(11.5,26){\textcolor{NDgold}{\footnotesize \cite{shen2013motion}}}
		\put(24,3){\textcolor{NDgold}{\footnotesize \cite{karulkarapplication,suzuki2007intention,brescianini2011ins}}}
		\put(72,3){\textcolor{NDgold}{\footnotesize \cite{Gambon20b,kalinowska2019data,thatte2019robust,sarac2013brain}}}
	\end{overpic}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\linewidth]{model_based.eps}
	\caption{General scheme for model-based estimation}\label{fig:model-based}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.5\linewidth]{learning_based.eps}
